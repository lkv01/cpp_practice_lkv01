...
// //     if(v[i] == 0) {dp[i][j] = 1+f(i+1,v[i],v,dp);}
// //     else if((v[i] == 1) || (v[i] == 2)) {
// //         if(j==v[i]) {dp[i][j] = 1+f(i+1,0,v,dp);}
// //         else dp[i][j] = f(i+1,v[i],v,dp);
// //     }
// //     else if(v[i] == 3) {
// //         if(j==1) {dp[i][j] = min(f(i+1,2,v,dp),1+f(i+1,0,v,dp));}
// //         else if(j==2) {dp[i][j] = min(f(i+1,1,v,dp),1+f(i+1,0,v,dp));}
// //         else {return min(min(f(i+1,1,v,dp),f(i+1,2,v,dp)),1+f(i+1,0,v,dp));}
// //     }
// //     return dp[i][j];
// // }
...
//         if(j==1) {dp[i][j] = min(f(i-1,2,v,dp),1+f(i-1,0,v,dp));}
//         else if(j==2) {dp[i][j] = min(f(i-1,1,v,dp),1+f(i-1,0,v,dp));}
//         else {dp[i][j] = min(min(f(i-1,1,v,dp),f(i-1,2,v,dp)),1+f(i-1,0,v,dp));}
//     }
//     return dp[i][j];
// }
...
//     cin>>n;
//     vector<int> v(n);
//     vector<vector<int>> dp(n,vector<int> (4,mod));
