// // Problem: City and Campers
// // Contest: HackerEarth - Data Structures - Disjoint Data Structures - Basics of Disjoint Data Structures
// // URL: https://www.hackerearth.com/practice/data-structures/disjoint-data-strutures/basics-of-disjoint-data-structures/practice-problems/algorithm/city-and-campers/
// // Memory Limit: 256 MB
// // Time Limit: 1000 ms
// // 
...
//         }
//         par[v] = u;
//         auto it1 = s.find(rnk[u]);
//         s.erase(it1);
//         auto it2 = s.find(rnk[v]);
//         s.erase(it2);
//         rnk[u]+=rnk[v];
//         s.insert(rnk[u]);
//     }
