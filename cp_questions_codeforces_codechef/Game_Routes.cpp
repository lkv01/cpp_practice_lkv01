...
//     //following line is incorrect way--!!!
//     // q.push(1);

//     //whenever doing topo_sort push all elements whose in_degree is 0 into the queue :)
...
//     //------------------------------>
//     // print(topo_sort);
//     for(int i{1} ; i<(int)topo_sort.size() ; i++) {
//         for(auto child:graph1[topo_sort[i]]) {
//             ways[topo_sort[i]]+=ways[child];
//             ways[topo_sort[i]]%=mod;
//         }
//     }
//     cout<<ways[n]<<"\n";
// }